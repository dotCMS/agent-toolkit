#!/usr/bin/env node
// Validates the Agent Plugins manifests against the published schemas.
// Adapted from sanity-io/agent-toolkit.
...
const documents = [
  { path: 'plugin.json', schemaUrl: 'https://agent-plugins.org/schemas/1.0.0/plugin.schema.json' },
  { path: 'mcp.json', schemaUrl: 'https://agent-plugins.org/schemas/1.0.0/mcp.schema.json' }
];
